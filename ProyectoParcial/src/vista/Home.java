...
public class Home extends javax.swing.JFrame {
    ...
    private void inicializarImagen(){
        ImageIcon img = new ImageIcon(new ImageIcon("src/imagenes/carrito.png").getImage().getScaledInstance(imagenLabel.getWidth(), imagenLabel.getHeight(), Image.SCALE_DEFAULT));
